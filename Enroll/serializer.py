...
class EnrollCoursePaymentSerializer(serializers.Serializer):
    ...
    def create(self, validated_data):
        ...
        post_body = {
            ...
            'success_url': f'https://online-school-989z.onrender.com/payment/success/{transaction_id}/{user.id}/{course.id}/',
            'fail_url': 'https://online-school-989z.onrender.com/payment/fail/',
            'cancel_url': 'https://online-school-989z.onrender.com/payment/cancel/',
