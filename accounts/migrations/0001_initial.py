    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(blank=True, choices=[('Male', 'Male'), ('Female', 'Female')], max_length=40)),
                ('birthday', models.DateField(default=django.utils.timezone.now)),
                ('is_teacher', models.BooleanField(default=False)),
                ('image', models.ImageField(default='images/default.png', upload_to='accounts/images/')),
